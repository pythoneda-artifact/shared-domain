"""
pythoneda/artifact/artifact_commit_pushed_listener.py
...
class ArtifactCommitPushedListener(Artifact, EventListener):
    """
    ...
    async def listen(cls, event: ArtifactCommitPushed) -> ArtifactCommitTagged:
        """
        ...
        result = await cls().tag_artifact(event)
        return result
