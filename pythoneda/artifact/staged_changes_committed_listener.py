"""
pythoneda/artifact/staged_changes_committed_listener.py
...
from pythoneda.shared.artifact_changes.events import StagedChangesCommitted, CommittedChangesPushed
from pythoneda.shared.git import GitPush, GitPushFailed

class StagedChangesCommittedListener(Artifact, EventListener):
    """
