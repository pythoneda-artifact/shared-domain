"""
pythoneda/artifact/committed_changes_pushed_listener.py
...
from pythoneda.shared.artifact_changes.events import CommittedChangesPushed, CommittedChangesTagged


class CommittedChangesPushedListener(Artifact, EventListener):
    """
