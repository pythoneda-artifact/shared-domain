"""
pythoneda/artifact/artifact_changes_committed_listener.py
...
from pythoneda.shared.artifact_changes.events import ArtifactChangesCommitted, ArtifactCommitPushed
from pythoneda.shared.git import GitPush, GitPushFailed

class ArtifactChangesCommittedListener(Artifact, EventListener):
    """
    ...
    async def push_artifact_commit(self, event: ArtifactChangesCommitted) -> ArtifactCommitPushed:
        """
